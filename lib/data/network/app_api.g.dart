...
class _AppServiceClient implements AppServiceClient {
  ...
  @override
  Future<LoginResponse> login(String userName, String password, int ver) async {
    ...
    _data.fields.add(MapEntry('ver', ver.toString()));
  ...
  Future<AllBrandBaseResponse> allBrand(int repPlanId) async {
    ...
    final _options = _setStreamType<AllBrandBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/getAllBrand.php',
  ...
  Future<AllPharmacyBaseResponse> getAllPharmacy(int repDet) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('repDet', repDet.toString()));
    final _options = _setStreamType<AllPharmacyBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/getAllPharmacy.php',
  ...
  Future<AllDoctorsBaseResponse> getAllDoctor(int repDet) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('repDet', repDet.toString()));
    final _options = _setStreamType<AllDoctorsBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/getAllDoctor.php',
  ...
  Future<AllHospitalBaseResponse> getAllHospital(int repDet) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('repDet', repDet.toString()));
    final _options = _setStreamType<AllHospitalBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/getAllHospital.php',
  ...
  Future<AllHospitalSpBaseResponse> getAllHospitalSp(int repDet) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('repDet', repDet.toString()));
    final _options = _setStreamType<AllHospitalSpBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<AllBrandSpBaseResponse> getBrandsSp(int repDet) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('repDet', repDet.toString()));
    final _options = _setStreamType<AllBrandSpBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/getBrandsSp.php',
  ...
  Future<AllPlanBrandsBaseResponse> getAllPlanBrands(
    ...
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.fields.add(MapEntry('repPlanIdActive', repPlanIdActive.toString()));
    if (repPlanIdOther != null) {
      _data.fields.add(MapEntry('repPlanIdOther', repPlanIdOther.toString()));
    }
    final _options = _setStreamType<AllPlanBrandsBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<DocDoctorsBaseResponse> docReport(int docId) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.fields.add(MapEntry('docId', docId.toString()));
    final _options = _setStreamType<DocDoctorsBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/docReport.php',
  ...
  Future<VisitHospitalBaseResponse> getHosVisit(
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('repPlanId', repPlanId.toString()));
    _data.fields.add(MapEntry('representativeId', representativeId.toString()));
    final _options = _setStreamType<VisitHospitalBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/getHosVisit.php',
  ...
  Future<VisitDoctorBaseResponse> getDocVisit(
    ...
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.fields.add(MapEntry('repPlanId', repPlanId));
    _data.fields.add(MapEntry('representativeId', representativeId));
    final _options = _setStreamType<VisitDoctorBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/getDocVisit.php',
  ...
  Future<AllPlanBrandsBaseResponse> getAllPlanBrandsType(
    ...
    _data.fields.add(MapEntry('repPlanIdActive', repPlanIdActive.toString()));
    if (flag != null) {
      _data.fields.add(MapEntry('flag', flag.toString()));
    }
    if (repPlanIdOther != null) {
      _data.fields.add(MapEntry('repPlanIdOther', repPlanIdOther.toString()));
    }
  ...
  Future<PlanBrandsBaseSpResponse> getRepPlanBrandSp(
    ...
    final _options = _setStreamType<PlanBrandsBaseSpResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/getRepPlanBrandSp.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PlanBrandsBaseSpResponse _value;
    try {
      _value = PlanBrandsBaseSpResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<LoginResponse> checkActivePlanBrand(int repDet, int ver) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = FormData();
  ...
  Future<AllBrandResResponse> getBrandRes(int repDet) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('repDet', repDet.toString()));
    final _options = _setStreamType<AllBrandResResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/reci/getBrands.php',
  ...
  Future<CheckReResponse> checkRe(int repDet) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('repDet', repDet.toString()));
    final _options = _setStreamType<CheckReResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/reci/checkRe.php',
  ...
  Future<CheckRepResponse> checkRep(int repDet) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('repDet', repDet.toString()));
    final _options = _setStreamType<CheckRepResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/reci/checkRep.php',
  ...
  Future<Message1Response> insertReci(
    ...
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.fields.add(MapEntry('recipeType', recipeType));
    _data.fields.add(MapEntry('repId', repId));
    _data.fields.add(MapEntry('type', type));
    _data.fields.add(MapEntry('docId', docId));
    _data.fields.add(MapEntry('spName', spName));
    _data.fields.add(MapEntry('brand_1', brand_1));
    _data.fields.add(MapEntry('address', address));
    _data.fields.add(MapEntry('phone', phone));
    _data.fields.add(MapEntry('total', total));
    if (flagImage1 != null) {
      _data.fields.add(MapEntry('flagImage1', flagImage1));
    }
    if (flagImage2 != null) {
      _data.fields.add(MapEntry('flagImage2', flagImage2));
    }
    if (note1 != null) {
      _data.fields.add(MapEntry('note1', note1));
    }
    if (note2 != null) {
      _data.fields.add(MapEntry('note2', note2));
    }
    if (image1 != null) {
      _data.files.add(
        MapEntry(
    ...
    if (brand_2 != null) {
      _data.fields.add(MapEntry('brand_2', brand_2));
    }
    if (brand_3 != null) {
      _data.fields.add(MapEntry('brand_3', brand_3));
    }
    if (brand_4 != null) {
      _data.fields.add(MapEntry('brand_4', brand_4));
    }
    if (note_emp != null) {
  ...
  Future<ReciNumResponse> reciNum() async {
    ...
    final _options = _setStreamType<ReciNumResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/reci/reciNum.php',
  ...
  Future<CopyRecResponse> copyReci(int docId, String recipeType) async {
    ...
    _data.fields.add(MapEntry('docId', docId.toString()));
    _data.fields.add(MapEntry('recipeType', recipeType));
    final _options = _setStreamType<CopyRecResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/reci/copyRe.php',
  ...
  Future<CopyRecResponse> getRepReci(int reciId) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.fields.add(MapEntry('reciId', reciId.toString()));
    final _options = _setStreamType<CopyRecResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<AllRepresentativeBaseResponse> getReps(int id, int cityId) async {
    ...
    _data.fields.add(MapEntry('cityId', cityId.toString()));
    final _options = _setStreamType<AllRepresentativeBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/getReps.php',
  ...
  Future<AllVisitNotesBaseResponse> getVisitNotes(int docId) async {
    ...
    final _options = _setStreamType<AllVisitNotesBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<AllVisitIssueBaseResponse> getVisitIssue(int id) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('repDet', id.toString()));
    final _options = _setStreamType<AllVisitIssueBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<AllRepVisitsResponseBaseResponse> getRepVisits(
    ...
    final _options = _setStreamType<AllRepVisitsResponseBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<Message1Response> readVisit(
    ...
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.fields.add(MapEntry('visitId', visitId.toString()));
    _data.fields.add(MapEntry('userId', userId.toString()));
    _data.fields.add(MapEntry('status', status.toString()));
    _data.fields.add(MapEntry('reqType', reqType.toString()));
    final _options = _setStreamType<Message1Response>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<Message1Response> changePlanBrandType(int id, int brandType) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.fields.add(MapEntry('id', id.toString()));
    _data.fields.add(MapEntry('brandType', brandType.toString()));
    final _options = _setStreamType<Message1Response>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/changePlanBrandType.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<AllReciBaseResponse> getAllRepReci(int repDet) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.fields.add(MapEntry('repId', repDet.toString()));
    final _options = _setStreamType<AllReciBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/reci/getAllRepReci.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AllReciBaseResponse _value;
    try {
      _value = AllReciBaseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<InfoDoctorBaseResponse> getDocInfo(int docId) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('docId', docId.toString()));
    final _options = _setStreamType<InfoDoctorBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<Message1Response> updateReci(
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('reciId', reciId.toString()));
    _data.fields.add(MapEntry('recipeType', recipeType.toString()));
    _data.fields.add(MapEntry('repId', repId));
    _data.fields.add(MapEntry('type', type));
    _data.fields.add(MapEntry('docId', docId));
    _data.fields.add(MapEntry('spName', spName));
    ...
    _data.fields.add(MapEntry('phone', phone));
    _data.fields.add(MapEntry('total', total));
    _data.fields.add(MapEntry('create_date', create_date));
    if (note1 != null) {
      _data.fields.add(MapEntry('note1', note1));
    }
    if (note2 != null) {
    ...
    if (print_date != null) {
      _data.fields.add(MapEntry('print_date', print_date));
    }
    if (active != null) {
  ...
  Future<ActiveBrandPlanBaseResponse> getinfoPlanBrandsType(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ActiveBrandPlanBaseResponse _value;
    try {
      _value = ActiveBrandPlanBaseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<CheckBaseResponse> checkPlanBrand(int repPlanId) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('repPlanId', repPlanId.toString()));
    final _options = _setStreamType<CheckBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/checkPlanStatus.php',
  ...
  Future<AllReadResponse> getVisitReadStatus(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AllReadResponse _value;
    try {
      _value = AllReadResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<SeniorByCityidBaseResponse> getSeniorByCityid(int cityId) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('cityId', cityId.toString()));
    final _options = _setStreamType<SeniorByCityidBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/getSeniorByCityid.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SeniorByCityidBaseResponse _value;
    try {
      _value = SeniorByCityidBaseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<SeniorByCityidBaseResponse> getCityAndTeamleader() async {
    ...
    final _options = _setStreamType<SeniorByCityidBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/getCityAndTeamleader.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<AllSearchHospitalNoteBaseResponse> getSearchHospitalsNotes(
    ...
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.fields.add(MapEntry('hosId', hosId.toString()));
    _data.fields.add(MapEntry('spId', spId.toString()));
    final _options = _setStreamType<AllSearchHospitalNoteBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/getHospitalsNotes.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AllSearchHospitalNoteBaseResponse _value;
    try {
      _value = AllSearchHospitalNoteBaseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<AllSearchHospitalBaseResponse> getSearchHospitals(String name) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AllSearchHospitalBaseResponse _value;
    try {
      _value = AllSearchHospitalBaseResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<Message1Response> updateRepPlanBrandAmount(
    ...
    final _options = _setStreamType<Message1Response>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/updateRepPlanBrandAmount.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<FinishedPlansBaseResponse> getFinishedPlans(int cityId) async {
    ...
    final _data = FormData();
    _data.fields.add(MapEntry('cityId', cityId.toString()));
    final _options = _setStreamType<FinishedPlansBaseResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/getFinishedPlans.php',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
