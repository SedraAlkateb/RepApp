...
abstract class RemoteDataSource {
  ...
  Future<AllNoVisitDoctorBaseResponse> noVisitDoc(int repDet, int planId);
  Future<AllNoVisitDoctorBaseResponse> getUnfinishedDoctorVisits(
      int repDet, int planId);
  Future<AllNoVisitDoctorBaseResponse> visitDoc(int repDet, int planId);
  ...
  Future<PlanBrandsInfoBaseResponse> getInfoPlanBrands(int repPlanId);
...
class RemoteDataSourceImpl implements RemoteDataSource {
  ...
  @override
  Future<InsertRecipeBaseResponse> insertReci(ReciRequest reciReq) async {
  ...
  @override
  Future<ActiveBrandPlanBaseResponse> getinfoPlanBrandsType(
      int repPlanId, {int status=0}) async {
    return await _appServiceClient.getinfoPlanBrandsType(repPlanId,status: status);
  }

  @override
  Future<PlanBrandsInfoBaseResponse> getInfoPlanBrands(int repPlanId) async {
    return await _appServiceClient.getInfoPlanBrands(repPlanId);
  }
  ...
  Future<AllReadResponse> getVisitReadStatus(
    ...
    return await _appServiceClient.getVisitReadStatus(
  ...
  Future<AllNoVisitDoctorBaseResponse> getUnfinishedHosVisits(
      int repPlanId) async {
    return await _appServiceClient.getUnfinishedHosVisits(repPlanId);
  }

  @override
  Future<AllNoVisitDoctorBaseResponse> noVisitHos(
      int repDet, int planId) async {
    return await _appServiceClient.noVisitHos(repDet, planId);
  }
  ...
  @override
  Future<ListHosSpSearchBaseResponse> docSpSearch(int repPlanId, int spId) async {
    return await _appServiceClient.docSpSearch(repPlanId,spId);
  }

  @override
  Future<ListHosSpSearchBaseResponse> hosSpSearch(int repPlanId, int spId)async {
    return await _appServiceClient.hosSpSearch(repPlanId,spId);
  }
}
