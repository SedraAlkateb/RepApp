...
Widget ButtonWidget(Function()? onPressed, String text) {
  return Padding(
    padding: EdgeInsets.symmetric(
        horizontal: 2.w, vertical: 8.h), // مسافة عن حواف الشاشة
    child: SizedBox(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          backgroundColor:
              ColorManager.medicalPrimary, // نفس اللون الأزرق في صورك
          foregroundColor: Colors.white, // لون النص
          shape: RoundedRectangleBorder(
            borderRadius:
                BorderRadius.circular(20.r), // زوايا منحنية لتناسب بقية الواجهة
          ),
