  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(
            // 🌟 تغليف TextFormField بـ Material شفاف لحل المشكلة
            child: Material(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  filled: true, // 🌟 يفضل تفعيل filled ليعمل fillColor بشكل صحيح
                  ...
                  hintText: 'ابحث هنا',
                  hintStyle:
                  TextStyle(fontSize: 16.sp, overflow: TextOverflow.fade),
                ),
              ),
            ),
          ),
