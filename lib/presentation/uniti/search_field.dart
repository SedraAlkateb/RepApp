            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                contentPadding: EdgeInsets.symmetric(horizontal: 20,vertical: 10),
                  enabledBorder:  OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(AppSize.s8))),
                  focusedBorder: const OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(15))),
                  hintText: 'ابحث هنا',
                  hintStyle:  TextStyle(fontSize: AppSize.s16,overflow: TextOverflow.fade ),
              ),
            ),
          ),
