...
class UpdateRecipesPage extends StatefulWidget {
  const UpdateRecipesPage({
    super.key,
    required this.docId,
    required this.st,
...
class _UpdateRecipesHospitalState extends State<UpdateRecipesPage> {
  ...
  void initState() {
    // =========================================================
    // نفس السلوك والترتيب الأصلي تماماً
    // =========================================================
                          ...
                          children: [
                            ...
                            BlocBuilder<RecipesBrandBloc, RecipesBrandState>(
                              builder: (
                                ...
                                return _buildDoctorTypeSection(
                                  context,
                                  ui,
                                );
                              },
  ...
  Widget _buildDoctorTypeSection(
    ...
    final selectedType =
        context.watch<RecipesBrandBloc>().insertRecipesObject.type;
  ...
  Widget _buildFirstBrandField(
    ...
    // مهم:
    // initialValue محفوظ كما في الكود الأصلي
    return FormField<BrandRes>(
      initialValue: bloc.insertRecipesObject.brand_1,
      validator: (value) {
        if (value == null) {
        ...
        return Column(
          ...
          children: [
            DropDownRecipesSearch(
              ...
              // نفس النتيجة الفعلية في الكود الأصلي
              // لأن state داخل FormField هو FormFieldState
              hintText: bloc.insertRecipesObject.brand_1.title_en,
  ...
  Widget _buildUpdateSection(
    ...
    return BlocListener<RecipesBrandBloc, RecipesBrandState>(
      listener: (context, state) async {
        // =====================================================
        // نفس Listener وتسلسل الحالات الأصلي تماماً
        // =====================================================
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            // لا تغيير بالسلوك:
            // لا unfocus إضافي ولا event إضافي
