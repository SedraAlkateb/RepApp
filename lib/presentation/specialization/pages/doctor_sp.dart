                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text("قائمة الاطباء المسجين",style: TextStyle(
                            ...
                            Container(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(color: ColorManager.medicalPrimary, fontSize: 11.sp),
                              ),
                            ),
                          ],
                        ),
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 8.w,),
                                      Expanded(
                                        child: Text(state.doctors[index].address,
                                            style: TextStyle
                                              (color: Colors.grey,
                                                fontSize: 15.sp)),
                                      ),
                                      ...
                                      InkWell(
                                        onTap: () {
                                          Navigator.pushNamed(
                                            context,
                                            Routes.visitDoctor,
                                            arguments:state.doctors[index], // نرسل الـ ID هنا
                                          );
