...
import 'package:domina_app/presentation/upload_delete/widget/async/async_content.dart';
import 'package:flutter/material.dart';

class AsyncResponsiveLayout extends StatelessWidget {
  const AsyncResponsiveLayout({
    super.key,
