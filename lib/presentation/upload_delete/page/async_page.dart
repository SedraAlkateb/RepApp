...
import 'package:flutter_screenutil/flutter_screenutil.dart'; // تأكد من استيرادها للأبعاد
...
class _AsyncPageState extends State<AsyncPage> with TickerProviderStateMixin {
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    // 2. الرسم التوضيحي مع الأنيميشن (رفع البيانات)
                    Container(
                      width: 260.w,
                      height: 260.w,
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                const DatabaseWidget(), // ويدجت السيرفر
                              ],
                            ),
