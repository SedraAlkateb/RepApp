...
class BrandPlanBloc extends Bloc<BrandPlanEvent, BrandPlanState> {
  ...
  BrandPlanBloc(
    ...
    on<AllBrandPlanEvent>((event, emit) async {
    ...
    on<SearchBrandEvent>((event, emit) async {
    ...
    on<ChangeFieldEvent>((event, emit) async {
    ...
    on<UpdateAmountSucEvent>((event, emit) async {
