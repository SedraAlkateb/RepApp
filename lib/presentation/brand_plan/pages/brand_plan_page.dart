...
class BrandPlanPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      length: 2,
      child: Scaffold(
        resizeToAvoidBottomInset: false, // يمنع انكماش الصفحة عند ظهور الديالوغ أو الكيبورد
        ...
        body: Column(
          children: [
            ...
            // =====================================================
            // Tab Content (مرن ويستوعب التغير بالارتفاع)
            // =====================================================
            const Expanded(
              child: TabBarView(
