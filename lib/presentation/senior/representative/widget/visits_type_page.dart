    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: NestedScrollView(
          ...
          headerSliverBuilder: (context, innerBoxIsScrolled) {
            return [
              ...
              SliverAppBar(
                ...
                title: Text(
                  ...
                  style: TextStyle(
                    ...
                    fontSize:
                        deviceType == AppDeviceType.mobilePortrait ? 18 : 20,
                  ),
                ),
              ),
              ...
              SliverPersistentHeader(
                pinned: true,
                delegate: _VisitsTabHeaderDelegate(
                  height: tabHeight + (tabOuterPadding * 2),
                  backgroundColor: const Color(
                    0xFFF8FAFC,
                  ),
                  child: Center(
          ...
          // Content
          // =================================================
          // doctor/hospital بيطبّقوا قيد pageMaxWidth بأنفسهم داخلياً على
          // محتواهم (مو على كامل الـ Scrollable تبعهم)، فلا داعي نكرر
          // التقييد هون؛ تكراره كان يمنع السكرول بالماوس بالفراغ الجانبي.
          body: TabBarView(
            // نفس السلوك
...
class _VisitsTabHeaderDelegate extends SliverPersistentHeaderDelegate {
  final double height;
  final Widget child;
  ...
  @override
  bool shouldRebuild(
    covariant _VisitsTabHeaderDelegate oldDelegate,
  ) {
