...
class DoctorSenior extends StatefulWidget {
  const DoctorSenior({super.key});

  @override
  State<DoctorSenior> createState() => _DoctorSeniorState();
}

class _DoctorSeniorState extends State<DoctorSenior> {
