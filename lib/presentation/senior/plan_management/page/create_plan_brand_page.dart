...
class _CreatePlanBrandPageState extends State<CreatePlanBrandPage> {
  ...
  void _showConfirmationDialog(BuildContext context) {
    showDialog(
      context: context,
      barrierDismissible:
          false, // يمنع إغلاق النافذة عند الضغط خارجها لضمان التركيز
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          shape: RoundedRectangleBorder(
            borderRadius:
                BorderRadius.circular(20), // زوايا دائرية متناسقة مع الكروت
          ),
          title: Row(
            children: [
              Icon(Icons.help_outline,
                  color: ColorManager.medicalPrimary, size: 28),
              ...
              child: SearchField(
                ...
                onPressed: (value) {
                  context
                      ...
                      .add(SearchPlanBrandEvent(value));
                },
              ),
            ),
            Expanded(
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        brand.brandType.color.withOpacity(0.08),
