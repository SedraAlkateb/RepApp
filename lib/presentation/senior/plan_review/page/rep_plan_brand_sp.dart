...
import 'package:domina_app/presentation/senior/plan_review/widget/floating_action_button.dart';
            ...
            child: BlocConsumer<FutureRepBloc, FutureRepState>(
              ...
              builder: (context, state) {
                ...
                if (state is AmountState) {
                  sumTargetAss = SumBrandAmountModel(state.targetAmount,
                      state.assistantAmount, state.totalAmount);
                }
                // =================================================
                // Loading
                // =================================================
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildSampleStatisticsTypeSummaryCard(sumTargetAss),
                      SizedBox(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: item.brandType.color.withOpacity(
                            0.08,
                          ),
                          borderRadius: BorderRadius.circular(
                            ui.smallRadius + 2,
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            fillColor: isEditable
                                ? item.brandType.color.withOpacity(
                                    0.055,
                                  )
                                : const Color(
                                    0xFFF8FAFC,
