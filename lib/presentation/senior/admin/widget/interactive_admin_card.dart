...
class _InteractiveAdminCardState extends State<InteractiveAdminCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool isTabletLandscape = deviceType == AppDeviceType.tabletLandscape;

    final double portraitIconSize = isTabletLandscape ? 25.sp : 28.sp;

    final double portraitTitleSize = isTabletLandscape ? 16.sp : 17.sp;

    final double portraitSubtitleSize = isTabletLandscape ? 12.sp : 12.sp;
    ...
    return Row(
      children: [
        ...
        Icon(
          ...
          size: isTabletLandscape(context) ? 11.sp : 16.sp,
        ),
      ],
    );
  }
        ...
        Row(
          ...
          children: [
            ...
            Icon(
              Icons.arrow_forward_ios,
              color: _isPressed ? widget.iconColor : Colors.grey[300],
              size: isTabletLandscape(context) ? 10.sp : 14.sp,
            ),
          ],
        ),
        SizedBox(
  ...
  bool isTabletLandscape(BuildContext context) {
    return AppResponsive.deviceType(context) == AppDeviceType.tabletLandscape;
  }
}
